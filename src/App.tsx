    ...
    <div className="min-h-screen bg-white text-slate-900 overflow-x-hidden selection:bg-amber-200">
      ...
      <section className="relative min-h-[90vh] flex flex-col items-center justify-center bg-[#050505] text-white px-4 py-20 overflow-hidden">
        <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none opacity-20">
          ...
          <div className="absolute top-1/2 -right-24 w-80 h-80 bg-amber-700 rounded-full blur-[100px]" />
        </div>
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-col items-center mb-8">
              <p className="text-4xl md:text-6xl font-black text-amber-500">
                12x de <span className="text-5xl md:text-8xl">R$ 1,99</span>
              </p>
              <p className="text-2xl md:text-4xl font-bold text-slate-300 mt-2">ou R$ 19,90 à vista</p>
            </div>
      ...
      <section className="py-24 px-4 bg-white text-center">
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <div className="mb-16">
              <p className="text-7xl md:text-9xl font-black text-slate-900 tracking-tight">R$ 19,90</p>
